(function(){
    var dom = document.querySelector('#todo'),
        ...
        apply_btn = dom.querySelector('.js_item_apply_btn'),
    ...
    function setItemActions(item, index) {
        ...
        var apply_b = item.querySelector('.js_item_apply_btn');
        ...
        edit_btn.addEventListener('click', function() {
            ...
            apply_b.style.display = 'inline-block';
            this.style.display = 'none';
            console.log(index);
        })
        apply_b.addEventListener('click', function() {
